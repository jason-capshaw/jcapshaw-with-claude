...
Most out-of-the-box search engines handle maybe two of those well. The rest requires investment: configuration, data normalization, and testing against real query logs.
